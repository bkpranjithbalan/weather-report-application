...
import { Calendar, Sunrise, Sunset, Moon, Sun, Thermometer } from "lucide-react";
  ...
  return (
    <div className="animate-fade-up space-y-6">
      <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
        <div className="glass rounded-full flex items-center px-5 py-3 gap-3 w-full sm:w-auto">
            ...
            <div className="glass rounded-2xl p-6">
              ...
              <div className="flex gap-3 overflow-x-auto pb-2">
                {historicalData.hourly.map((h, i) => (
                  <div key={i} className="glass-subtle rounded-xl p-3 min-w-[100px] flex flex-col items-center gap-1 shrink-0">
